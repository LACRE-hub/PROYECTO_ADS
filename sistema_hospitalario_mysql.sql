-- ================================================================
--  SISTEMA HOSPITALARIO v7 — Script MySQL/MariaDB
--  Compatible con XAMPP (MySQL 8+ / MariaDB 10.4+)
--  Ejecutar completo de una sola vez en phpMyAdmin o CLI
-- ================================================================
...
-- ── ELIMINAR TABLAS SI EXISTEN (orden inverso de FK) ────────────
...
-- ================================================================
--  DATOS DE PRUEBA
--  NOTA: Las contraseñas son temporales. Ejecuta php/setup_passwords.php
--        para reemplazarlas por hashes bcrypt válidos (clave: MediCore_2024)
-- ================================================================

INSERT INTO ROL (nombre_rol, descripcion) VALUES
('Administrador', 'Acceso total al sistema'),
('Médico',        'Consulta, prescripción y referencia'),
('Enfermero',     'Registro de signos vitales y notas de enfermería'),
('Farmacéutico',  'Gestión de lotes y despacho de medicamentos'),
('Cajero',        'Registro y cobro de pagos'),
('Técnico Lab',   'Captura de resultados de estudios'),
('Paciente',      'Consulta de próxima cita — acceso mínimo');
...
(102, 'Cardiología',       'Activo'),
(103, 'Pediatría',         'Activo'),
(201, 'Urgencias',         'Activo'),
(202, 'Ginecología',       'En mantenimiento'),
(203, 'Neurología',        'Activo'),
(301, 'Ortopedia',         'Activo');

-- Contraseña temporal: 'TEMP' — reemplazar con setup_passwords.php
...
('0000000001', 'Carlos',   'Ramírez',   'López',     'Administrador', 'Matutino',   'Dirección',        'Activo', NULL,         NULL,         NULL,                  '$2y$12$/gVj2/QGA7sECFGdspNCg.hB0CdJAPVNK5ayGY3eiigXJ.sUd8YhC', 1, NULL),
('0000000002', 'Ana',      'González',  'Martínez',  'Médico',        'Matutino',   'Medicina General', 'Activo', NULL,         NULL,         NULL,                  '$2y$12$J5dUc/GCuHc.6MwETncsKeMVofNANYTnv0oVl6KBwgv9dvZf.q4wu', 2, 1),
('0000000003', 'Jorge',    'Hernández', 'Ruiz',      'Médico',        'Vespertino', 'Cardiología',      'Activo', NULL,         NULL,         NULL,                  '$2y$12$45rReI/A.a9aVpxlBft/u.M7G5sPy7pZCv7.yEZN5UFdLnZiGOSki', 2, 2),
('0000000004', 'Sofía',    'Torres',    'Vega',      'Enfermero',     'Matutino',   'Hospitalización',  'Activo', NULL,         NULL,         NULL,                  '$2y$12$YwPQgxFA.i8wOHWgvvGuBeyjD90cNwokHl49yR1Z8YJEYA5qFPDJy', 3, NULL),
('0000000005', 'Luis',     'Castillo',  'Mora',      'Farmacéutico',  'Matutino',   'Farmacia',         'Activo', NULL,         NULL,         NULL,                  '$2y$12$1FsIGuEUozwrZZhnoz2t6uS4H5M8956AHXwPD/5cI4vrxASQLEYZS', 4, NULL),
('0000000006', 'Mariana',  'Flores',    'Ríos',      'Cajero',        'Matutino',   'Caja',             'Activo', NULL,         NULL,         NULL,                  '$2y$12$1VKE6JwDZXydzKZcnGpsq..mWUtvl5FNkDgDfHe8yU0bMgScvMJxe', 5, NULL),
('0000000007', 'Pedro',    'Vargas',    'Salinas',   'Técnico Lab',   'Matutino',   'Laboratorio',      'Activo', NULL,         NULL,         NULL,                  '$2y$12$Ast06hib4Kl4.zdtrTuU3OMTbO0iicNoPZGPygilwzJD58RCONnMG', 6, NULL),
('0000000008', 'Fernanda', 'Medina',    'Cruz',      'Médico',        'Nocturno',   'Pediatría',        'Activo', NULL,         NULL,         NULL,                  '$2y$12$.Q4WOb4xuAT/tQf.wod/jeqpkb50CYdXkMwAtzx.NKT6B9CV0ccvS', 2, 3),
('0000000009', 'Roberto',  'Jiménez',   'Ponce',     'Enfermero',     'Vespertino', 'Urgencias',        'Activo', NULL,         NULL,         NULL,                  '$2y$12$BTuGlhpt9TVWqZNVjOQFZOJuaiAH6haWTTwu3b3M68CcYR6YIPm8a', 3, NULL),
('0000000010', 'Gabriela', 'Soto',      'Méndez',    'Farmacéutico',  'Vespertino', 'Farmacia',         'Baja',   '2025-12-31', '2025-12-31', 'Renuncia voluntaria', '$2y$12$LUKWwWJZxJrm8sluzpV2veFWd0Yufqkwxx8FGtQ9VJI8ZoPCm/yLG', 4, NULL),
('0000000011', 'Diego',    'Reyes',     'Acosta',    'Médico',        'Matutino',   'Neurología',       'Activo', NULL,         NULL,         NULL,                  '$2y$12$h7Dydg6uQgHhbjpyvGeO/eaNm.CPyBnzanu90hfb9WD7q1UpBMGaS', 2, 6),
('0000000012', 'Valeria',  'Gutiérrez', 'Paredes',   'Médico',        'Matutino',   'Ortopedia',        'Activo', NULL,         NULL,         NULL,                  '$2y$12$nZ3YS46tYngs1gt0Rek5guht/ZLNh586E82oD6gtEnSkvaJd5sP9m', 2, 7),
('0000000013', 'Héctor',   'Morales',   'Ibáñez',    'Técnico Lab',   'Vespertino', 'Laboratorio',      'Activo', NULL,         NULL,         NULL,                  '$2y$12$jP7jGOZY5LY32SoApZ9EMe3FfNbOPz6DueFyjghKHKH2xIpgbyYwK', 6, NULL),
...
('0000000015', 'Andrés',   'Peña',      'Domínguez', 'Enfermero',     'Nocturno',   'Hospitalización',  'Activo', NULL,         NULL,         NULL,                  '$2y$12$.9AhGPy0kuzlrKmLl3SVqe.zuciGjoxS35AhyHv/ZpaxfFihF4RXS', 3, NULL);
...
(3,  'CED-2345678', 'Cardiología',      'Electrofisiología'),
(8,  'CED-3456789', 'Pediatría',        NULL),
(11, 'CED-4567890', 'Neurología',       'Neurología Vascular'),
(12, 'CED-5678901', 'Ortopedia',        'Cirugía de Columna');

INSERT INTO DIRECCION_PACIENTE (calle, numero, colonia, codigo_postal, ciudad, estado) VALUES
('Av. Insurgentes Sur',       '1234', 'Del Valle',        '03100', 'Ciudad de México', 'CDMX'),
('Calle Hidalgo',             '56',   'Centro Histórico', '06060', 'Ciudad de México', 'CDMX'),
('Blvd. Tlalpan',             '890',  'Pedregal',         '14200', 'Ciudad de México', 'CDMX'),
('Calle Morelos',             '12',   'Santa María',      '44600', 'Guadalajara',      'Jalisco'),
('Av. Juárez',                '77',   'Col. Obregón',     '64000', 'Monterrey',        'Nuevo León'),
('Calle 5 de Mayo',           '321',  'Centro',           '72000', 'Puebla',           'Puebla'),
('Blvd. Adolfo López Mateos', '450',  'Las Fuentes',      '22010', 'Tijuana',          'Baja California'),
('Av. Chapultepec',           '900',  'Roma Norte',       '06760', 'Ciudad de México', 'CDMX');
...
('0000000001', 'María',     'López',   'Fuentes',  '1985-03-12', 'F', 'LOFM850312MDFPXR01', 'maria.lopez@correo.com',   1),
('0000000002', 'Juan',      'Pérez',   'Sánchez',  '1978-07-25', 'M', 'PESJ780725HDFRNQ02', 'juan.perez@correo.com',    2),
('0000000003', 'Elena',     'García',  'Morales',  '1992-11-04', 'F', 'GAME921104MDFRCL03', 'elena.garcia@correo.com',  3),
('0000000004', 'Miguel',    'Torres',  'Ramírez',  '2005-01-18', 'M', 'TORM050118HDFRNL04', 'tutor.torres@correo.com',  4),
...
('0000000007', 'Lucía',     'Mendoza', 'Ortega',   '2001-02-28', 'F', 'MEOL010228MDFNRT07', 'lucia.mendoza@correo.com', 7),
('0000000008', 'Ricardo',   'Ávila',   'Fuentes',  '1955-12-10', 'M', 'AVFR551210HDFLNS08', 'ricardo.avila@correo.com', 8);

INSERT INTO CONTACTO_PACIENTE (id_paciente, nombre_contacto, telefono, parentesco, es_emergencia, orden) VALUES
(1, 'Pedro López Fuentes',   '5551234567', 'Hermano', 1, 1),
(1, 'Rosa Fuentes de López', '5557654321', 'Madre',   0, 2),
(2, 'Clara Sánchez Vidal',   '5552345678', 'Esposa',  1, 1),
(3, 'Luis García Morales',   '5553456789', 'Padre',   1, 1),
(4, 'Susana Ramírez Díaz',   '5554567890', 'Madre',   1, 1),
(5, 'Antonio Ruiz Castro',   '5555678901', 'Hijo',    1, 1),
(6, 'Gloria Espinoza Vega',  '5556789012', 'Madre',   1, 1),
(7, 'Carlos Ortega Ríos',    '5557890123', 'Padre',   1, 1),
(8, 'Silvia Fuentes Mora',   '5558901234', 'Esposa',  1, 1),
(8, 'Jorge Ávila Fuentes',   '5559012345', 'Hijo',    0, 2);

INSERT INTO EXPEDIENTE_CLINICO (id_paciente, grupo_sanguineo, alergias, enfermedades_cronicas, fecha_apertura) VALUES
(1, 'O+',  'Penicilina',             'Hipertensión arterial',                      '2020-01-15'),
...
(5, 'O-',  'Látex',                   'Artritis reumatoide, Hipotiroidismo',         '2018-04-18'),
(6, 'A-',  'Ibuprofeno',              'Gastritis crónica',                           '2024-01-20'),
(7, 'B+',  'Ninguna conocida',        'Ninguna',                                    '2024-07-11'),
(8, 'O+',  'Contraste yodado',        'Insuficiencia renal crónica estadio 3, HTA', '2015-08-30');
...
(1, 2,  '2026-04-08 09:00:00', '2026-04-08 09:00:00', NULL,                    'Control de presión arterial',         'Completada',  'Control'),
(2, 2,  '2026-04-10 10:30:00', '2026-04-10 10:30:00', NULL,                    'Revisión de glucosa y HbA1c',         'Completada',  'Control'),
(3, 3,  '2026-04-15 11:00:00', '2026-04-08 11:00:00', 'Paciente fuera de CDMX','Dolor en el pecho al esfuerzo',       'Completada',  'Primera vez'),
(4, 8,  '2026-04-20 08:00:00', '2026-04-20 08:00:00', NULL,                    'Crisis asmática leve',                'Completada',  'Urgencia'),
(5, 2,  '2026-05-05 09:30:00', '2026-05-05 09:30:00', NULL,                    'Dolor articular en manos y rodillas', 'Completada',  'Control'),
(1, 3,  '2026-05-12 10:00:00', '2026-05-12 10:00:00', NULL,                    'Evaluación cardiológica preventiva',  'Completada',  'Especialidad'),
(6, 2,  '2026-05-18 11:00:00', '2026-05-18 11:00:00', NULL,                    'Dolor epigástrico frecuente',         'Completada',  'Primera vez'),
(7, 8,  '2026-05-22 09:00:00', '2026-05-22 09:00:00', NULL,                    'Revisión general anual',              'Completada',  'Control'),
(8, 11, '2026-05-25 10:00:00', '2026-05-25 10:00:00', NULL,                    'Cefalea intensa recurrente',          'Completada',  'Primera vez'),
(2, 2,  '2026-06-10 10:30:00', '2026-06-10 10:30:00', NULL,                    'Control diabetes — 2 meses',          'Pendiente',   'Control'),
(5, 12, '2026-06-12 09:00:00', '2026-06-12 09:00:00', NULL,                    'Valoración articulaciones',           'Pendiente',   'Especialidad'),
(3, 3,  '2026-06-18 11:30:00', '2026-06-11 11:30:00', 'Médico con guardia',    'Seguimiento angina estable',          'Pendiente',   'Control');

INSERT INTO CONSULTA (id_cita, id_medico, id_paciente, diagnostico, tratamiento, notas, fecha_hora) VALUES
(1, 2,  1, 'Hipertensión arterial estadio 1',
   'Losartán 50 mg c/24 h, restricción de sodio, ejercicio aeróbico 30 min/día',
   'PA 148/92 mmHg. Refiere cefalea matutina. Sin edema en miembros.',
   '2026-04-08 09:15:00'),
(2, 2,  2, 'Diabetes mellitus tipo 2 descontrolada',
   'Metformina 850 mg c/12 h con alimentos. Dieta hipoglucídica. Control en 2 meses.',
   'HbA1c 8.4%. Glucosa basal 168 mg/dL. Pies sin lesiones. Retina pendiente.',
   '2026-04-10 10:45:00'),
(3, 3,  3, 'Angina de pecho estable',
   'Atenolol 50 mg/día, nitroglicerina sublingual SOS, evitar esfuerzo brusco.',
   'EKG en reposo sin alteraciones. Prueba de esfuerzo solicitada. Sin soplos.',
   '2026-04-15 11:20:00'),
(4, 8,  4, 'Crisis asmática leve',
   'Salbutamol 2 puff c/6 h por 5 días. Budesonida inhalada mantenimiento.',
...
(5, 2,  5, 'Artritis reumatoide con actividad moderada',
   'Metotrexato 15 mg/semana, ácido fólico 5 mg/semana, naproxeno 500 mg c/12 h.',
   'DAS28 = 4.1. Rigidez matutina 45 min. Tumefacción MCF II-III bilateral.',
   '2026-05-05 09:45:00'),
(6, 3,  1, 'Evaluación cardiológica preventiva — sin cardiopatía estructural',
   'Continuar Losartán. Ecocardiograma en 12 meses. Ejercicio moderado.',
   'ECG normal. Sin soplos. FEVI 65%. PA 132/82 mmHg.',
   '2026-05-12 10:20:00'),
(7, 2,  6, 'Gastritis crónica antral por H. pylori probable',
   'Omeprazol 20 mg/día + amoxicilina 1 g c/12 h + claritromicina 500 mg c/12 h × 14 días.',
   'Epigastralgia 6/10 posprandial. Sin hematemesis. Panendoscopia pendiente.',
   '2026-05-18 11:15:00'),
(8, 8,  7, 'Paciente sana — revisión general sin hallazgos patológicos',
   'Vacuna Td aplicada. Vitamina D 1000 UI/día. Próximo control en 1 año.',
   'Peso 58 kg, Talla 165 cm, IMC 21.3. PA 110/70. Exploración física normal.',
   '2026-05-22 09:15:00'),
(9, 11, 8, 'Cefalea tensional crónica con componente migrañoso probable',
   'Amitriptilina 25 mg/noche. Ibuprofeno 400 mg en crisis. Manejo de estrés.',
   'Cefalea bilateral opresiva, 3-4 episodios/semana. Sin focalidad neurológica. TAC solicitada.',
   '2026-05-25 10:20:00');
...
(1, 2,  1, 'Laboratorio', 'Biometría hemática completa',           '2026-04-08 09:20:00', 'Resultado disponible'),
(2, 2,  2, 'Laboratorio', 'Glucosa en ayuno y HbA1c',              '2026-04-10 10:50:00', 'Resultado disponible'),
(3, 3,  3, 'Cardiología', 'Prueba de esfuerzo con telemetría',     '2026-04-15 11:30:00', 'Resultado disponible'),
(4, 8,  4, 'Imagen',      'Radiografía de tórax PA y lateral',     '2026-04-20 08:35:00', 'Resultado disponible'),
...
(9, 11, 8, 'Imagen',      'TAC de cráneo sin contraste',           '2026-05-25 10:30:00', 'Resultado disponible');

INSERT INTO RESULTADO_ESTUDIO (id_orden, id_tecnico, resultado,
  ruta_archivo, fecha_captura, estatus, requiere_impresion) VALUES
(1, 7,  'Hb 13.2 g/dL, leucocitos 7 200/μL, plaquetas 210 000/μL. Sin alteraciones relevantes.',
...
(4, 7,  'Campos pulmonares con hiperinsuflación leve. Sin consolidaciones ni derrame.',
...
(3, 3,  3, 'Cardiología Intervencionista',
   'Angina estable con factores de riesgo múltiples; requiere estratificación avanzada.',
   'Femenina 33 a. EKG basal normal. Prueba de esfuerzo negativa. Síntomas persisten.',
...
(9, 11, 8, 'Nefrología',
   'IRC estadio 3 con HTA de difícil control y cefalea crónica.',
   'Creatinina 2.1 mg/dL. TFGe 38 mL/min. HTA con Losartán 100 mg sin control óptimo.',
...
('Losartán potásico',  'Cozaar',     'Tableta 50 mg',             'Antihipertensivo',   100, 'Lunes a viernes'),
('Metformina HCl',     'Glucophage', 'Tableta 850 mg',            'Antidiabético',      150, 'Lunes a sábado'),
('Atenolol',           'Tenormin',   'Tableta 50 mg',             'Beta-bloqueador',     80, 'Lunes a viernes'),
('Salbutamol',         'Ventolin',   'Inhalador 100 μg/dosis',    'Broncodilatador',     50, 'Lunes a domingo'),
('Nitroglicerina',     'Nitrostat',  'Tableta sublingual 0.5 mg', 'Antianginal',         40, 'Lunes a viernes'),
('Paracetamol',        'Tempra',     'Tableta 500 mg',            'Analgésico',         200, 'Lunes a domingo'),
('Omeprazol',          'Losec',      'Cápsula 20 mg',             'Inhibidor de bomba', 120, 'Lunes a sábado'),
('Amoxicilina',        'Amoxil',     'Cápsula 500 mg',            'Antibiótico',        100, 'Lunes a sábado'),
('Budesonida',         'Pulmicort',  'Inhalador 200 μg/dosis',    'Corticosteroide',     30, 'Lunes a domingo'),
('Metotrexato',        'Methofar',   'Tableta 2.5 mg',            'FARME',               40, 'Lunes a viernes'),
('Naproxeno sódico',   'Naprosyn',   'Tableta 500 mg',            'AINE',                80, 'Lunes a sábado'),
...
(1, 6,  '500 mg',  'Una tableta cada 8 h en caso de cefalea, máx 3/día',     15),
(2, 2,  '850 mg',  'Una tableta con desayuno y una con cena',                60),
(3, 3,  '50 mg',   'Una tableta cada 24 h por la mañana',                    30),
(3, 5,  '0.5 mg',  'Una tableta sublingual en crisis, máx 3/día',            10),
(4, 4,  '100 μg',  'Dos puff cada 6 h por 5 días',                            1),
(4, 9,  '200 μg',  'Un puff cada 12 h como mantenimiento',                    1),
(5, 10, '15 mg',   'Seis tabletas de 2.5 mg una vez por semana (lunes)',      24),
(5, 11, '500 mg',  'Una tableta cada 12 h con alimentos',                    56),
(6, 7,  '20 mg',   'Una cápsula en ayuno 30 min antes del desayuno',         14),
(6, 8,  '500 mg',  'Una cápsula cada 12 h con alimentos durante 14 días',    28),
...
(1, 'Individual', 'Hospitalización Gral', 'Disponible',  1),
(2, 'Individual', 'Hospitalización Gral', 'Disponible',  1),
(3, 'UCI',        'Cuidados Intensivos',  'Disponible',  4),
(4, 'Individual', 'Pediatría',            'Disponible',  3),
(5, 'Individual', 'Hospitalización Gral', 'En limpieza', 2),
(6, 'Doble',      'Hospitalización Gral', 'Disponible',  1),
(7, 'Individual', 'Cardiología',          'Ocupada',     2);
...
(4, 4,  1, 'Administración de medicamento',
   'Salbutamol 2 puff aplicado. Paciente tolera bien. SpO2 sube a 99%.', '2026-04-20 10:00:00'),
(4, 4,  1, 'Control de signos vitales',
   'FC 88, FR 18, Temp 36.8°C, PA 108/68. Paciente estable y tranquilo.','2026-04-20 14:00:00'),
(1, 9,  2, 'Administración de medicamento',
   'Losartán 50 mg vía oral. Sin reacciones adversas. Paciente cooperador.','2026-03-10 21:00:00'),
(1, 15, 2, 'Cambio de posición',
   'Cambio postural c/2 h para prevenir úlceras por presión. Piel íntegra.','2026-03-11 02:00:00'),
(8, 4,  3, 'Control de signos vitales',
   'PA 148/94, FC 88, SpO2 97%, Temp 37.0°C. Pendiente ajuste antihipertensivo.','2026-05-25 18:00:00'),
(8, 15, 3, 'Administración de medicamento',
   'Losartán 100 mg administrado. Paciente refiere leve mejoría de cefalea.','2026-05-25 22:00:00');

INSERT INTO INSUMO (nombre_articulo, categoria, stock_actual, stock_minimo, area_asignada) VALUES
('Guantes de nitrilo talla M',         'Consumible', 450, 100, 'Hospitalización'),
('Jeringas 5 mL',                      'Consumible', 290,  80, 'Enfermería'),
('Electrocardiógrafo 12 derivaciones', 'Equipo',       2,   1, 'Cardiología'),
('Oxímetro de pulso portátil',         'Equipo',       7,   2, 'Urgencias'),
('Gasas estériles 10x10 cm',           'Consumible', 780, 200, 'Quirófano'),
('Catéter venoso periférico 20G',      'Consumible', 120,  40, 'Urgencias'),
('Tensiómetro digital de pared',       'Equipo',       5,   2, 'Hospitalización'),
...
(1, 4,  'Salida',   50, 'Uso hospitalización paciente 0000000004', '2026-04-20 09:30:00'),
(2, 9,  'Salida',   10, 'Toma de muestras en urgencias',           '2026-04-20 08:00:00'),
(1, 4,  'Entrada', 200, 'Reposición de stock mensual',             '2026-04-01 08:00:00'),
(6, 9,  'Salida',    8, 'Canalización de pacientes en urgencias',  '2026-05-25 11:30:00'),
(8, 15, 'Salida',   12, 'Solución IV paciente 0000000008',         '2026-05-25 12:00:00'),
(5, 4,  'Salida',   20, 'Curación herida paciente 0000000001',     '2026-03-10 14:00:00');

INSERT INTO ALERTA_STOCK (id_insumo, tipo_origen, area, stock_al_momento, fecha_generacion, estatus) VALUES
(4, 'Stock mínimo', 'Urgencias',  7, '2026-05-24 07:00:00', 'Activa'),
(2, 'Stock mínimo', 'Enfermería', 85,'2026-05-20 07:00:00', 'Resuelta');
...
(1, 'Hospitalización', NULL, NULL, NULL, 2,    6000.00, '4 días cama individual (Mar 10–14)'),
(1, 'Consulta',        1,    NULL, NULL, NULL,  350.00, 'Consulta medicina general'),
(1, 'Despacho',        NULL, NULL, 1,    NULL,  255.00, 'Losartán 30 tab + Paracetamol 15 tab'),
(1, 'Estudio',         NULL, 1,    NULL, NULL, 1245.00, 'Biometría hemática completa'),
(2, 'Hospitalización', NULL, NULL, NULL, 1,    3600.00, '2 días cama pediatría (Abr 20–22)'),
(2, 'Consulta',        4,    NULL, NULL, NULL,  350.00, 'Consulta pediatría urgencia'),
(2, 'Despacho',        NULL, NULL, 6,    NULL,  245.00, 'Salbutamol inhalador'),
(2, 'Despacho',        NULL, NULL, 7,    NULL,  335.00, 'Budesonida inhalador'),
(2, 'Estudio',         NULL, 4,    NULL, NULL,  760.00, 'Radiografía de tórax'),
(3, 'Consulta',        2,    NULL, NULL, NULL,  350.00, 'Consulta medicina general'),
(3, 'Despacho',        NULL, NULL, 3,    NULL,  360.00, 'Metformina 60 tab'),
(4, 'Consulta',        3,    NULL, NULL, NULL,  350.00, 'Consulta cardiología'),
...
(6, 'Despacho',        NULL, NULL, 10,   NULL,   98.00, 'Omeprazol 14 cáps'),
(6, 'Despacho',        NULL, NULL, 11,   NULL,  126.00, 'Amoxicilina 28 cáps'),
(7, 'Hospitalización', NULL, NULL, NULL, 3,    2000.00, '1 día cama cardiología (May 25)'),
(7, 'Consulta',        9,    NULL, NULL, NULL,  350.00, 'Consulta neurología'),
(7, 'Estudio',         NULL, 7,    NULL, NULL, 1650.00, 'TAC de cráneo sin contraste'),
...
(7, 6, 1, 'Error en concepto hospitalización — se capturó tarifa incorrecta',
...
(1, '2026-06-15 22:00:00', 240, 'Actualización del sistema y respaldo general de base de datos', 'Programado'),
(1, '2026-04-20 01:00:00', 120, 'Mantenimiento servidor de archivos de estudios y resultados',  'Completado'),
(1, '2026-03-01 02:00:00',  60, 'Parche de seguridad módulo de autenticación',                  'Completado');

INSERT INTO ALERTA_MANTENIMIENTO (id_mantenimiento, area_notificada, fecha_envio, estatus_envio) VALUES
(1, 'Médicos',     '2026-06-14 08:00:00', 'Enviado'),
(1, 'Enfermería',  '2026-06-14 08:00:00', 'Enviado'),
...
(1,  'Empleados', 'Alta de empleado',            '2026-01-10 08:30:00', '192.168.1.10', 'Alta de 0000000015 (Andrés Peña Domínguez)'),
(2,  'Consulta',  'Nueva consulta generada',     '2026-04-08 09:15:00', '192.168.1.21', 'Consulta paciente 0000000001 — Hipertensión estadio 1'),
(5,  'Farmacia',  'Despacho de medicamento',     '2026-04-08 10:02:00', '192.168.1.30', 'Despacho Losartán 30 tab, Lote LOT-LOS-2025-A'),
(2,  'Consulta',  'Nueva consulta generada',     '2026-04-10 10:45:00', '192.168.1.21', 'Consulta paciente 0000000002 — Diabetes descontrolada'),
(3,  'Consulta',  'Nueva consulta generada',     '2026-04-15 11:20:00', '192.168.1.22', 'Consulta paciente 0000000003 — Angina estable'),
...
(7,  'Cita',      'Consulta de próxima cita',    '2026-06-01 07:45:00', '192.168.2.55', 'Paciente 0000000003 consultó su cita pendiente'),
(11, 'Consulta',  'Nueva consulta generada',     '2026-05-25 10:20:00', '192.168.1.23', 'Consulta paciente 0000000008 — Cefalea crónica'),
(1,  'Sistema',   'Respaldo completado',         '2026-04-20 03:05:00', '192.168.1.10', 'Respaldo nocturno exitoso. Tamaño: 2.4 GB');
