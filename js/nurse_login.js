...
const pwInput    = document.getElementById('nursePassword');
...
if (form) {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const pw         = document.getElementById('nursePassword').value;
        let valid        = true;
        ...
        try {
            const res  = await fetch('php/login.php', {
                ...
                body: JSON.stringify({ tipo: 'enfermero', identificador: employeeId, password: pw, captcha: captchaToken }),
            });
